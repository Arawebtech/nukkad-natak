...
//           {/* RIGHT */}
//    <div
//   className="fade-up border border-black border"
//   style={{
...
>
  ...
  >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
      ...
      {/* LEFT */}
      <div className="fade-up flex flex-col gap-10 h-full">
        ...
        <div>
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 md:gap-6">
            <div className="">
              ...
              <p className="text-[16px] leading-[26px] pt-3 text-black font-semibold">
                Share your requirements and our team will help you plan and
                execute the perfect street play campaign that connects with
                people and delivers real impact.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between flex-1">
          ...
          {/* Contact Box */}
          <div
            className="border border-[#b8aea5] rounded-[4px] flex items-start gap-4 mt-auto"
            style={{
              padding: "22px 24px",
      ...
      {/* RIGHT */}
      <div
        className="fade-up border border-black h-full flex flex-col"
        style={{
          padding: "clamp(20px, 5vw, 40px) clamp(0px, 5vw, 40px)",
          borderRadius: "12px 12px",
        }}
      >
        ...
        {/* UPDATED */}
        <form
          className="space-y-5 form-wrapper flex flex-col h-full"
        ...
        >
          ...
          <button
            type="submit"
            className="w-full h-[40px] rounded-md bg-[#f26a0a] hover:bg-[#de5f08] transition-all duration-300 text-white text-[16px] font-semibold mt-auto"
          >
            Submit Application
          </button>
        </form>
